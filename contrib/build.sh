...
echo "./miner --url dalia.primecoin.org:9915/api/jsonrpc --user NO --pass NO   --wallet AbMXJscCQUP28rySq8NYorqHouEo5zF8eH" >> xpmminercpu
chmod +x xpmminercpu
cd ..
...
echo "LD_LIBRARY_PATH=\$DIR/. ./miner --url dalia.primecoin.org:9915/api/jsonrpc --user NO --pass NO   --wallet AbMXJscCQUP28rySq8NYorqHouEo5zF8eH" >> xpmminernv
chmod +x xpmminernv
mkdir -p xpm/cuda
...
echo ".\miner.exe --url dalia.primecoin.org:9915/api/jsonrpc --user NO --pass NO   --wallet AbMXJscCQUP28rySq8NYorqHouEo5zF8eH" > xpmminernv.bat
