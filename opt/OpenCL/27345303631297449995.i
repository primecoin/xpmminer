# 1 "/tmp/comgr-3176dc/input/CompileSource"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 390 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tmp/comgr-3176dc/input/CompileSource" 2
...
# 6 "/tmp/comgr-3176dc/input/CompileSource" 2
...
#pragma pack(pop)
# 7 "/tmp/comgr-3176dc/input/CompileSource" 2
#pragma OPENCL EXTENSION cl_amd_printf : enable
# 29 "/tmp/comgr-3176dc/input/CompileSource"
...
# 62 "/tmp/comgr-3176dc/input/CompileSource"
...
{
# 602 "/tmp/comgr-3176dc/input/CompileSource"
  ulong R0x = op1l0.x * op2l0.x;
  ulong R0y = op1l0.y * op2l0.x;
  ulong R0z = op1l0.z * op2l0.x;
  ulong R0w = op1l0.w * op2l0.x;
...
# 652 "/tmp/comgr-3176dc/input/CompileSource"
}
...
{
# 671 "/tmp/comgr-3176dc/input/CompileSource"
  ulong R0x = op1l0.x * op2l0.x;
  ulong R0y = op1l0.y * op2l0.x;
  ulong R0z = op1l0.z * op2l0.x;
  ulong R0w = op1l0.w * op2l0.x;
...
# 744 "/tmp/comgr-3176dc/input/CompileSource"
}
...
{
# 765 "/tmp/comgr-3176dc/input/CompileSource"
  ulong R0x = op1l0.x * op2l0.x;
  ulong R0y = op1l0.y * op2l0.x;
  ulong R0z = op1l0.z * op2l0.x;
  ulong R0w = op1l0.w * op2l0.x;
...
# 849 "/tmp/comgr-3176dc/input/CompileSource"
}
