/* Compiler options:
-c -emit-llvm -target amdgcn-amd-amdhsa -x cl -O0 -cl-kernel-arg-info -I/usr/local/share/xpmminer -DFixedPrimorial=19 -DL1CacheSize=8192 -DWeaveDepth=7936 -DGroupSize=256 -DExtensionsNum=9 -DChainLength=10 -DFixedRoundsNum=112 -D__OPENCL_VERSION__=200 -D__IMAGE_SUPPORT__=1 -Xclang -cl-ext=+cl_khr_fp64,+cl_khr_global_int32_base_atomics,+cl_khr_global_int32_extended_atomics,+cl_khr_local_int32_base_atomics,+cl_khr_local_int32_extended_atomics,+cl_khr_int64_base_atomics,+cl_khr_int64_extended_atomics,+cl_khr_3d_image_writes,+cl_khr_byte_addressable_store,+cl_khr_fp16,+cl_khr_gl_sharing,+cl_amd_device_attribute_query,+cl_amd_media_ops,+cl_amd_media_ops2,+cl_khr_image2d_from_buffer,+cl_khr_subgroups,+cl_amd_copy_buffer_p2p,+cl_amd_assembly_program -mllvm -amdgpu-prelink -mcode-object-version=5  -include opencl-c.h 
Hash to override:
  Source: 0x40121eef206528
  Source + clang options: 0xa0c2ae0332433843
*/
