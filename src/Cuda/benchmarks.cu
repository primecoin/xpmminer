__global__ void squareBenchmark320(
    uint32_t* m1,
    uint32_t* out,
...
__global__ void squareBenchmark352(
    uint32_t* m1,
    uint32_t* out,
    unsigned elementsNum) {
...
__global__ void multiplyBenchmark320(
    uint32_t* m1,
    uint32_t* m2,
    uint32_t* out,
    unsigned elementsNum) {
...
__global__ void multiplyBenchmark352(
    uint32_t* m1,
    uint32_t* m2,
    uint32_t* out,
    unsigned elementsNum) {
...
__global__ void fermatTestBenchMark320(
    uint32_t* numbers,
    uint32_t* out,
    unsigned elementsNum) {
#define OperandSize 10
...
__global__ void fermatTestBenchMark352(
    uint32_t* numbers,
    uint32_t* out,
    unsigned elementsNum) {
#define OperandSize 11
