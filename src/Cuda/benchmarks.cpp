...
void cudaRunBenchmarks(
    ...
    for (unsigned i = 0; i < CUDAKernelsNum; i++)
        CUDA_SAFE_CALL(
            cuModuleGetFunction(&kernels[i], module, gCUDAKernelNames[i]));
