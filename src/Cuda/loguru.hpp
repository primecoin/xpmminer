...
loguru::g_preamble
  ...
  * Version 1.7.2 - 2018-04-22 - Fix a bug where large file names could cause
stack corruption (thanks @ccamporesi)
...
/*  Should be called from the main thread.
  ...
  flag. Note that -v does not affect file logging (see loguru::add_file).
...
/*
  ...
  thread. This can be very useful for when you have a parent thread spawning
  several working threads, and you want the error context of the parent thread
  to get printed (too) when there is an error on the child thread. You can
  accomplish this thusly:
