...
static const uint32_t DifficultyFractionalMask =
    (1U << DifficultyFractionalBits) - 1;
...
class PrimeSource {
   ...
   public:
    ...
    uint32_t primesNum() const {
        return _primesNum;
    }
    uint32_t prime(uint32_t N) const {
        return _primes[N];
    }
    ...
    uint32_t* isNewMultipliersPtr() {
        return _isNewMultiplier;
    }
    uint32_t* primesCombinedPtr() {
        return _primesCombined;
    }
    uint32_t* multipliersPtr() {
        return _multipliers;
    }
    uint64_t* multiplier64Ptr() {
        return _multipliers64;
    }
    uint64_t* combinedMultipliersPtr() {
        return _combinedMultipliers;
    }
    uint32_t* offsetsPtr() {
        return _offsets;
    }
    uint32_t* offsets64Ptr() {
        return _offsets64;
    }
    uint32_t* combinedOffsetsPtr() {
        return _combinedOffsets;
    }

    bool isNewMultiplier(unsigned N) const {
        return _isNewMultiplier[N];
    }
    unsigned primesCombined(unsigned N) const {
        return _primesCombined[N];
    }
    uint32_t multiplier(unsigned N) const {
        return _multipliers[N];
    }
    uint64_t multiplier64(unsigned N) const {
        return _multipliers64[N];
    }
    unsigned offset(unsigned N) const {
        return _offsets[N];
    }
    unsigned offset64(unsigned N) const {
        return _offsets64[N];
    }
    uint64_t combinedMultiplier(unsigned N) const {
        return _combinedMultipliers[N];
    }
    unsigned combinedOffset(unsigned N) const {
        return _combinedOffsets[N];
    }
};
