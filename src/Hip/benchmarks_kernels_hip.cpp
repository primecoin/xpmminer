// Simple inline multiplication for benchmarks - uses standard schoolbook algorithm
__device__ void simpleMul256(uint32_t *result, const uint32_t *op1, const uint32_t *op2) {
  // Zero result
  ...
  for (int i = 0; i < 8; i++) {
    uint64_t carry = 0;
    for (int j = 0; j < 8; j++) {
      uint64_t product = (uint64_t)op1[i] * (uint64_t)op2[j] + result[i+j] + carry;
...
__device__ void simpleMul384(uint32_t *result, const uint32_t *op1, const uint32_t *op2) {
  // Zero result
...
extern "C" __global__ void multiplyBenchmark256(uint32_t *m1,
                                     uint32_t *m2,
                                     uint32_t *out,
...
extern "C" __global__ void multiplyBenchmark384(uint32_t *m1,
                                     uint32_t *m2,
                                     uint32_t *out,
                                     unsigned elementsNum)
{
...
extern "C" __global__ void squareBenchmark320(uint32_t *m1,
                                   uint32_t *out,
                                   unsigned elementsNum)
{
...
extern "C" __global__ void squareBenchmark352(uint32_t *m1,
                                   uint32_t *out,
                                   unsigned elementsNum)
{
...
extern "C" __global__ void multiplyBenchmark320(uint32_t *m1,
                                     uint32_t *m2,
                                     uint32_t *out,
                                     unsigned elementsNum)
{
...
extern "C" __global__ void multiplyBenchmark352(uint32_t *m1,
                                     uint32_t *m2,
                                     uint32_t *out,
                                     unsigned elementsNum)
{
...
extern "C" __global__ void fermatTestBenchMark320(uint32_t *numbers,
                                       uint32_t *out,
                                       unsigned elementsNum)
{
#define OperandSize 10  
...
extern "C" __global__ void fermatTestBenchMark352(uint32_t *numbers,
                                       uint32_t *out,
                                       unsigned elementsNum)
{
#define OperandSize 11  
