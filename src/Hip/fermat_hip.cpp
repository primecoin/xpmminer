...
extern "C" __global__ void setup_fermat(uint32_t *fprimes,
...
extern "C" __global__ void check_fermat(fermat_t *info_out,
                             uint32_t *count,
...
extern "C" __global__ void setup_sieve(uint32_t *offset1,
                            uint32_t *offset2,
